...
<head>
    ...
    <title>Sidharth - Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="users.php">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="../images/sid.png" width="50" height="50" alt="" style="border-radius: 50%;">
                </div>
                <div class="sidebar-brand-text mx-3">Sidharth</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Sidharth</span>
                                <img class="img-profile rounded-circle" src="../images/sid.png">
                            </a>
