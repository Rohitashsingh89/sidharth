			...
			<div class="contact-content content-width">
				<div class="section-header">
					<h4 class="subtitle scroll-animation" data-animation="fade_from_bottom">
						<i class="las la-dollar-sign"></i> Register
					</h4>
				...
				<form class="contact-form scroll-animation" data-animation="fade_from_bottom" action="php/signup.php" method="post">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="input-group">
								...
								<input type="text" name="fname" id="fname" placeholder="Full Name" value="<?php echo (isset($_GET['fname'])) ? htmlspecialchars($_GET['fname']) : "" ?>">
						...
						<div class="col-md-12">
							<div class="input-group submit-btn-wrap">
								<button class="theme-btn" name="submit" type="submit">Register</button>
							</div>
						</div>
						<p class="mt-3">Already have an account?<a href="login.php" class="link-secondary"> Login</a></p>
